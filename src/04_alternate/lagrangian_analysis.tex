...
show significant reductions in the launch energy. Improvements are summarized in
table \ref{tab:earth-vs-l2-transfers}. Also, parking a spacecraft at L2
allows for more reaction time before targeting the object, since the spacecraft
is already in space.
...
\begin{table}[H]
  ...
  \label{tab:earth-vs-l2-transfers}
\end{table}
